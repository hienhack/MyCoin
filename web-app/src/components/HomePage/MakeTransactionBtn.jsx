...
function MakeTransactionBtn() {
  return (
    <Link to="/make-transaction" className="w-1/2">
      <div className="flex border-2 rounded-md group hover:bg-indigo-900 hover:bg-opacity-80 hover:text-white hover:cursor-pointer">
        <div className="hidden lg:flex items-center justify-center w-1/2 text-6xl xl:text-7xl text-yellow-400 group-hover:text-white">
          <IcMakeTransaction />
        </div>
