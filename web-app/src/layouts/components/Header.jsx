...
function Header() {
  return (
    <div className="mx-auto md:flex justify-between items-center py-5">
      <Link to="/">
        <div className="flex justify-center items-center text-7xl mb-10 md:mb-0">
          <img src="/images/LogoLight.svg" className="size-14" />
          <div className="text-3xl font-semibold ml-2 select-none text-indigo-900">
            MyCoin
          </div>
        </div>
      </Link>
      <div className="flex justify-evenly space-x-4 text-sm">
        <Link to={"/create-wallet"}>
          <div className="flex items-center space-x-2 border py-2 px-4 rounded-md border-indigo-800 text-indigo-800">
        ...
        <Link to={"/access-wallet"}>
          <div className="flex items-center space-x-2 bg-indigo-800 py-2 px-4 rounded-md border text-white">
